...
{
    /// <inheritdoc />
    public partial class AddClinicsAndAssets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    AssetType = table.Column<string>(type: "TEXT", maxLength: 60, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assets_Clinics_ClinicId",
                        column: x => x.ClinicId,
